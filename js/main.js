...
/*************************************************************************************
1. No, var x should be the global variable and var y, the local.
2. console.log(y) would be undefined, because it does not have access to the local var y.
console.log(x) would print "I'm a local variable", because it does have access to the
global var x;
**************************************************************************************/
...
/*************************************************************************************
console.log(x) would return "undefined", there is not console.log(y).
...
/**************************************************************************************
------------ ANSWER -------------------
Console.log inside the IFEE will return 4.  The console.log outside the IFEE will
return an error with add being undefined.
**************************************************************************************/
